...
class Script(Base):
    ...
    # The all symbol is a synonym for save-update, merge, refresh-expire, expunge, delete, and using it 
    # in conjunction with delete-orphan indicates that the child object should follow along with its parent in all cases, 
    ...
    def __repr__(self):
        return f'<Script {self.title} from author {self.author}>'
